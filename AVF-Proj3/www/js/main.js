...
window.addEventListener("DOMContentLoaded", function(){              
    ...
    document.addEventListener("deviceready", onDeviceReady, false);
                        ...
                        var connects = {};
                        connects[Connection.UNKNOWN]  = 'a connection that I have never seen.';
                        connects[Connection.ETHERNET] = 'some ethernet connection';
                        connects[Connection.WIFI]     = 'WiFi! Awesome!';
                        connects[Connection.CELL_2G]  = '2G connection. Connect to WiFi for better speed.';
                        connects[Connection.CELL_3G]  = '3G connection. That is a nice speed.';
                        connects[Connection.CELL_4G]  = '4G connection. You have some speed on you!';
                        connects[Connection.NONE]     = 'no connection. :-(';
                        
                        alert('I see that you have ' + connects[whatNetwork]);
                        }
